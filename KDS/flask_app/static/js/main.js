...
const translations = {
    ...
    'en': {
        ...
        'Malzeme Adına Göre Arama': 'Search by Material Name',
        'Ara': 'Search',
        'Hareket Türü': 'Movement Type',
        'Malzeme Kodu': 'Material Code',
        'Malzeme Adı': 'Material Name',
        'Malzeme Açıklaması': 'Material Description',
        'Birim': 'Unit',
        'Giriş Miktarı': 'Inward Quantity',
        'Çıkış Miktarı': 'Outward Quantity',
        'Minimum Miktar': 'Minimum Quantity',
        'Kritik Miktar': 'Critical Quantity',
        'Maximum Miktar': 'Maximum Quantity',
        'Yıllık Miktar': 'Annual Quantity',
        'Stok Fazlası': 'Stock Surplus',
        'Son Kullanım Tarihi': 'Expiry Date',
        'Seri / Lot Numarası': 'Serial / Lot Number',
        "Excel'e Aktar": 'Export to Excel',
        'Baskı Önizleme': 'Print Preview',
        'Malzemenin Belgelerini Görüntüle': 'View Material Documents',
        'Bu sayfa şu an örnek veri ile gösterilmektedir. SQL bağlantısı eklendiğinde canlı stok verisine dönecektir.': 'This page currently shows sample data. It will switch to live stock data when SQL is connected.',
        'Toplam Malzeme Kalemi': 'Total Material Items',
        'Yeterli Stok': 'Sufficient Stock',
        'Kritik Seviye': 'Critical Level',
        '📊 Stok Durum Tablosu': '📊 Stock Status Table',
        'Stok Mevcut Durum Detayı': 'Stock Status Detail',
        'Satır seçmek için tabloya tıklayın': 'Click a row in the table to select',
