...
def load_polyclinic_performance_data(start_date_str, end_date_str):
    ...
    try:
        ...
        with st.spinner("Poliklinik hasta verileri yükleniyor..."):
        ...
        st.error(f"❌ Poliklinik verisi yüklenirken hata oluştu: {e}")
        return pd.DataFrame()
    finally:
        conn.close()